...
Proposed changes to `specs/` resulting from this plan. **The Lead validates and finalizes** as `archive/<PLAN-ID>/delta.md` during the archive flow. Do not edit `specs/` directly.
